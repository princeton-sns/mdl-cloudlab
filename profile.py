"""CloudLab profile for multi-dispatch experiments."""
...
portal.context.defineParameter("replica_type", "Replica Hardware Type", portal.ParameterType.STRING, "c220g5")
portal.context.defineParameter("replica_disk_image", "Replica Disk Image", portal.ParameterType.STRING, "urn:publicid:IDN+emulab.net+image+Praxis:msd710.client1")
...
portal.context.defineParameter("client_type", "Client Hardware Type", portal.ParameterType.STRING, "c220g5")
portal.context.defineParameter("client_disk_image", "Client Disk Image", portal.ParameterType.STRING, "urn:publicid:IDN+emulab.net+image+Praxis:msd710.client1")
...
portal.context.defineParameter("control_type", "Control Hardware Type", portal.ParameterType.STRING, "c220g5")
